...
import { useMemo, createContext, useReducer, createElement, useContext, useRef as useRef$1, useEffect as useEffect$1, useState as useState$2, useCallback, isValidElement, cloneElement, useLayoutEffect, forwardRef, Children } from 'react';
...
var createReducer = function createReducer() {
  ...
  return function (reducer, initialState, initializer) {
    ...
    var _useState = useState$2(ref.current),
...
var createStateContext = function createStateContext(defaultInitialValue) {
  ...
  var StateProvider = function StateProvider(_ref) {
    ...
    var state = useState$2(initialValue !== undefined ? initialValue : defaultInitialValue);
    return providerFactory({
      value: state
    }, children);
  };
...
function useAsyncFn(fn, deps, initialState) {
  ...
  var _useState = useState$2(initialState),
    state = _useState[0],
    set = _useState[1];
...
function createHTMLMediaHook(tag) {
  return function (elOrProps) {
    ...
    if (element) {
      ...
      element = createElement(tag, _extends({
        controls: false
      }, props, {
        ref: ref,
        onPlay: wrapEvent(props.onPlay, onPlay),
...
function useUpdate() {
  var _useReducer = useReducer(updateReducer, 0),
...
var useCustomCompareEffect = function useCustomCompareEffect(effect, deps, depsEqual) {
  ...
  useEffect$1(effect, ref.current);
};
...
var useDefault = function useDefault(defaultValue, initialValue) {
  var _useState = useState$2(initialValue),
    value = _useState[0],
    setValue = _useState[1];
...
var useFullscreen = function useFullscreen(ref, enabled, options) {
  ...
  var _useState = useState$2(enabled),
...
var useGetSetState = function useGetSetState(initialState) {
  ...
  var update = useUpdate();
  var state = useRef$1(_extends({}, initialState));
  var get = useCallback(function () {
    return state.current;
  }, []);
...
var createBreakpoint = function createBreakpoint(breakpoints) {
  ...
  return function () {
    var _useState = useState$2(isBrowser ? window.innerWidth : 0),
      screen = _useState[0],
...
var useKeyPress = function useKeyPress(keyFilter) {
  var _useState = useState$2([false, null]),
    state = _useState[0],
    set = _useState[1];
...
var useLocalStorage = function useLocalStorage(key, initialValue, options) {
  ...
  var initializer = useRef$1(function (key) {
    try {
...
var useLocationBrowser = function useLocationBrowser() {
  var _useState = useState$2(buildState('load')),
    state = _useState[0],
    setState = _useState[1];
  useEffect$1(function () {
...
var useMap = function useMap(initialMap) {
  ...
  var _useState = useState$2(initialMap),
    map = _useState[0],
    _set = _useState[1];
...
var useMedia = function useMedia(query, defaultState) {
  var _useState = useState$2(getInitialState(query, defaultState)),
    state = _useState[0],
    setState = _useState[1];
  useEffect$1(function () {
    var mounted = true;
...
function useNetworkState(initialState) {
  var _useState = useState$2(initialState != null ? initialState : getConnectionState),
    state = _useState[0],
    setState = _useState[1];
  useEffect$1(function () {
...
function useRafLoop(callback, initiallyActive) {
  ...
  var rafActivity = useRef$1(false);
  var rafCallback = useRef$1(callback);
...
var useScratch = function useScratch(params) {
  ...
  var _useState = useState$2({
    ...
    state = _useState[0],
    setState = _useState[1];
  var refState = useRef$1(state);
  var refScratching = useRef$1(false);
  var refAnimationFrame = useRef$1(null);
  var _useState2 = useState$2(null),
    el = _useState2[0],
    setEl = _useState2[1];
  useEffect$1(function () {
    if (disabled) return;
...
var shallowEqualDepsList = function shallowEqualDepsList(prevDeps, nextDeps) {
  return prevDeps.every(function (dep, index) {
    return equal(dep, nextDeps[index]);
  });
};
...
var useSize = function useSize(element, _temp) {
  ...
  var sized = cloneElement.apply(React, [element, {
    style: style
  }].concat([createElement('iframe', {
    ref: ref,
    style: {
  ...
  })].concat(Children.toArray(element.props.children))));
  return [sized, state];
};
...
function useStateWithHistory(initialState, capacity, initialHistory) {
  ...
  var history = useRef$1(initialHistory != null ? initialHistory : []);
...
var useThrottle = function useThrottle(value, ms) {
  ...
  var _useState = useState$2(value),
    state = _useState[0],
    setState = _useState[1];
  var timeout = useRef$1();
...
function useScrollbarWidth() {
  var _useState = useState$2(scrollbarWidth()),
    sbw = _useState[0],
    setSbw = _useState[1];
...
function useMultiStateValidator(states, validator, initialValidity) {
  ...
  var _useState = useState$2(initialValidity),
    validity = _useState[0],
    setValidity = _useState[1];
  var validate = useCallback(function () {
    if (validatorInner.current.length >= 2) {
...
function useMeasure() {
  var _useState = useState$2(null),
    element = _useState[0],
    ref = _useState[1];
  var _useState2 = useState$2(defaultState$2),
    rect = _useState2[0],
...
var useSet = function useSet(initialSet) {
  ...
  var _useState = useState$2(initialSet),
    set = _useState[0],
    setSet = _useState[1];
  var stableActions = useMemo(function () {
...
function createGlobalState(initialState) {
  ...
  return function () {
    var _useState = useState$2(store.state),
